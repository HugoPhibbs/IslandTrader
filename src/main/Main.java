...
//		}
	 ...
	 * @return Island[] an adjusted array from input, containing all the islands, but with routes added between them 
	 */
	 ...
	 * 
	 * @param buyCatalogues ArrayList<HashMap<String, HashMap<String, Integer>>> contains all the buyCatalogues for every island to be created
	 * @param sellCatalogues ArrayList<HashMap<String, HashMap<String, Integer>>> contains all the sellCatalogues for every island to be created
	...
	public static Island[] createIslands(ArrayList<HashMap<String, HashMap<String, Integer>>> buyCatalogues, ArrayList<HashMap<String, HashMap<String, Integer>>> sellCatalogues) {
		...
		Store corsicaStore = new Store("Napoleans", "A bit of everything", sellCatalogues.get(2), sellCatalogues.get(2));
		...
		Store maltaStore = new Store("Duty Free Store", "Exotic goods", sellCatalogues.get(3), sellCatalogues.get(3));
		...
		Store ibizaStore = new Store("Party Store", "Medicines", sellCatalogues.get(4), sellCatalogues.get(4)); 
	 ...
	 * 
	 * @return ArrayList<HashMap<String, HashMap<String, Integer>>> contains all the sellCatalogues for every Island in the game
	 */
	 ...
	 * 
	 * @return ArrayList<HashMap<String, HashMap<String, Integer>>> contains all the buyCatalogues for every Island in the game
	 */
